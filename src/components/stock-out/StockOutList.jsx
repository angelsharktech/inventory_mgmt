...
const StockOutList = () => {
  // Static data for demonstration with receiver name
          ...
          >
            <Box flexGrow={1} width={isSmallScreen ? "100%" : "auto"} pt={2}>
              <FilterData 
                ...
                placeholder="Search by invoice, product, receiver or category..."
              />
            </Box>
            <Button
              variant="contained"
              ...
              onClick={handleOpen}
            >
              {isSmallScreen ? "Add Stock Out" : "Add Stock Out (alt+x)"}
            </Button>
          </Box>
        </Box>
            ...
            <Table>
              <TableHead sx={{ backgroundColor: "lightgrey" }}>
                <TableRow>
                  ...
                  <TableCell align="center"><strong>Receiver Name</strong></TableCell>
